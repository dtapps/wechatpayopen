module go.dtapp.net/wechatpayopen

go 1.18

require (
	go.dtapp.net/dorm v1.0.7
	go.dtapp.net/goip v1.0.22
	go.dtapp.net/golog v1.0.16
	go.dtapp.net/gorandom v1.0.0
...
require (
	...
	gitee.com/chunanyong/zorm v1.5.6 // indirect
	github.com/basgys/goxml2json v1.1.0 // indirect
	github.com/beego/beego/v2 v2.0.4 // indirect
	github.com/cespare/xxhash/v2 v2.1.2 // indirect
	github.com/denisenkom/go-mssqldb v0.12.2 // indirect
	github.com/dgryski/go-rendezvous v0.0.0-20200823014737-9f7001d12a5f // indirect
	github.com/dtapps/go-library/utils/gotime v0.0.0-20220321125442-5750f7eb2ca1 // indirect
	...
	go.dtapp.net/gostring v1.0.5 // indirect
